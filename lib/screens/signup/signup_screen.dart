...
import 'package:fakebook_frontend/blocs/signup/signup_state.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        body: Container(
            ...
            child: Padding(
                padding: EdgeInsets.fromLTRB(0, isHiddenKeyboard ? 0 : 0, 0, 0),
                child: Form(
                  key: formStateKey,
                  child: SingleChildScrollView(
                    child: Column(
                        ...
                        children: <Widget>[
                          Image.asset('assets/images/face-signup.png',width:double.infinity,height: 230, fit: BoxFit.fill,),
                          SizedBox(height: 20),
                          const Text(
                            style: TextStyle(
                          ...
                          Container(
                              padding: EdgeInsets.fromLTRB(40, isHiddenKeyboard ? 30 : 40, 40, 0),
                              child: Column(
